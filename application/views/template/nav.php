<div class="container">
                ...
                <div class="navbar-collapse collapse ">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="<?php echo isActive($pageName,"events")?>"><a href="<?php echo site_url('event') ?>">Events</a></li>
                        <li class="<?php echo isActive($pageName,"music")?>"><a href="<?php echo site_url('music') ?>">Artists</a></li>
